      ...
      <div className={selectors.photoDetailDiv}>
        <div className={selectors.myDetail}>
          <p>
            ...
            As a dedicated team player, I bring exceptional communication, collaboration,
            and problem-solving skills to the table. I&apos;m Confident in my ability
            to make a significant contribution to the team, working collectively
            to achieve project goals and deliver high-quality back-end solutions.
          </p>
        </div>
